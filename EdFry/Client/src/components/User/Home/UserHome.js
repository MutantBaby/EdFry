  ...
  return (
    <>
      ...
      <div className="mainUserHome">
          ...
          <div className="inner-page2-user">
            <Card/>
          </div>
      ...
      <div className="containerTeacher">
        ...
        <div className="btn">
          <a href="#">
            <i className="fa fa-clipboard" aria-hidden="true"></i>Assign
          </a>
          <a href="#">
      ...
      <div className="box">
        ...
        <div className="top">
          ...
          <div>
            ...
            <label className="heart" for="heart-btn-2"></label>
          </div>
        </div>
        <div className="userContent">
          <img
      ...
      <div className="box">
        ...
        <div className="top">
          ...
          <label className="heart" for="heart-btn-3"></label>
        </div>
        <div className="userContent">
          <img
      ...
      <div className="box">
        ...
        <div className="top">
          ...
          <label className="heart" for="heart-btn-4"></label>
        </div>
        <div className="userContent">
          <img
